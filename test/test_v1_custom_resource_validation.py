    ...
    def make_instance(self, include_optional) -> V1CustomResourceValidation:
        ...
        if include_optional:
            return V1CustomResourceValidation(
                open_apiv3_schema = kubernetes.models.v1/json_schema_props.v1.JSONSchemaProps(
                    __ref = '', 
                    __schema = '', 
                    additional_items = kubernetes.models.additional_items.additionalItems(), 
                    additional_properties = kubernetes.models.additional_properties.additionalProperties(), 
                    all_of = [
                        null
                        ], 
                    any_of = [
                    ...
                    example = kubernetes.models.example.example(), 
                    exclusive_maximum = True, 
                    exclusive_minimum = True, 
                    external_docs = kubernetes.models.v1/external_documentation.v1.ExternalDocumentation(
                        description = '', 
                        url = '', ), 
                    format = '', 
                    id = '', 
                    items = kubernetes.models.items.items(), 
                    max_items = 56, 
                    max_length = 56, 
                    max_properties = 56, 
                    maximum = 1.337, 
                    ...
                    minimum = 1.337, 
                    multiple_of = 1.337, 
                    not = kubernetes.models.v1/json_schema_props.v1.JSONSchemaProps(
                        __ref = '', 
                        __schema = '', 
                        additional_items = kubernetes.models.additional_items.additionalItems(), 
                        additional_properties = kubernetes.models.additional_properties.additionalProperties(), 
