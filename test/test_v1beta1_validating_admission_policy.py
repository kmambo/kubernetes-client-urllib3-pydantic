        ...
        if include_optional:
            return V1beta1ValidatingAdmissionPolicy(
                ...
                metadata = kubernetes.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '', 
                    uid = '', ),
                spec = kubernetes.models.v1beta1/validating_admission_policy_spec.v1beta1.ValidatingAdmissionPolicySpec(
                    audit_annotations = [
                        null
                        ], 
                    failure_policy = '', 
                ...
                status = kubernetes.models.v1beta1/validating_admission_policy_status.v1beta1.ValidatingAdmissionPolicyStatus(
                    conditions = [
                        null
                        ], 
