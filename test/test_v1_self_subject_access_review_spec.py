    ...
    def make_instance(self, include_optional) -> V1SelfSubjectAccessReviewSpec:
        ...
        if include_optional:
            return V1SelfSubjectAccessReviewSpec(
                non_resource_attributes = kubernetes.models.v1/non_resource_attributes.v1.NonResourceAttributes(
                    path = '', 
                    verb = '', ),
                resource_attributes = kubernetes.models.v1/resource_attributes.v1.ResourceAttributes(
                    field_selector = null, 
                    group = '', 
                    label_selector = null, 
                    name = '', 
