    ...
    def make_instance(self, include_optional) -> V1Event:
        ...
        if include_optional:
            return V1Event(
                ...
                deprecated_source = kubernetes.models.v1/event_source.v1.EventSource(
                    component = '', 
                    host = '', ),
                ...
                note = '',
                reason = '',
                regarding = kubernetes.models.v1/object_reference.v1.ObjectReference(
                    api_version = '', 
                    field_path = '', 
                    kind = '', 
                    name = '', 
                    ...
                    resource_version = '', 
                    uid = '', ),
                related = kubernetes.models.v1/object_reference.v1.ObjectReference(
                    api_version = '', 
                    field_path = '', 
                    kind = '', 
                    name = '', 
                ...
                reporting_instance = '',
                series = kubernetes.models.v1/event_series.v1.EventSeries(
                    count = 56, 
