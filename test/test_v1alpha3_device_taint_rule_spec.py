    ...
    def make_instance(self, include_optional) -> V1alpha3DeviceTaintRuleSpec:
        ...
        if include_optional:
            return V1alpha3DeviceTaintRuleSpec(
                device_selector = kubernetes.models.v1alpha3/device_taint_selector.v1alpha3.DeviceTaintSelector(
                    device = '', 
                    device_class_name = '', 
                    driver = '', 
                    pool = '', 
                ...
                taint = kubernetes.models.v1alpha3/device_taint.v1alpha3.DeviceTaint(
                    effect = '', 
                    key = '', 
