...
from kubernetes.api.core_v1_api import CoreV1Api
...
class TestCoreV1Api(unittest.TestCase):
    ...
    def test_patch_namespaced_pod_resize(self) -> None:
    ...
    def test_read_namespaced_pod_resize(self) -> None:
    ...
    def test_replace_namespaced_pod_resize(self) -> None:
