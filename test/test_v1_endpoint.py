    ...
    def make_instance(self, include_optional) -> V1Endpoint:
        ...
        if include_optional:
            return V1Endpoint(
                ...
                conditions = kubernetes.models.v1/endpoint_conditions.v1.EndpointConditions(
                    ready = True, 
                    serving = True, 
                    terminating = True, ),
                deprecated_topology = {
                ...
                hints = kubernetes.models.v1/endpoint_hints.v1.EndpointHints(
                    for_zones = [
                        null
                        ], ),
                hostname = '',
                node_name = '',
                target_ref = kubernetes.models.v1/object_reference.v1.ObjectReference(
                    api_version = '', 
                    field_path = '', 
                    kind = '', 
                    name = '', 
