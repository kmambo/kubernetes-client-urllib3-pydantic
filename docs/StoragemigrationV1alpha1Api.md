# kubernetes.StoragemigrationV1alpha1Api
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.StoragemigrationV1alpha1Api(api_client)
    v1alpha1_storage_version_migration = kubernetes.V1alpha1StorageVersionMigration() # V1alpha1StorageVersionMigration | 
    ...
    try:
        api_response = api_instance.create_storage_version_migration(v1alpha1_storage_version_migration, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_storage_version_migration(name, v1alpha1_storage_version_migration, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_storage_version_migration_status(name, v1alpha1_storage_version_migration, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
