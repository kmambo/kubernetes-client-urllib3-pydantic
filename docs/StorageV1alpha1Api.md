...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.StorageV1alpha1Api(api_client)
    v1alpha1_volume_attributes_class = kubernetes.V1alpha1VolumeAttributesClass() # V1alpha1VolumeAttributesClass | 
    ...
    try:
        api_response = api_instance.create_volume_attributes_class(v1alpha1_volume_attributes_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
```python
import kubernetes
from kubernetes.models.v1alpha1_volume_attributes_class_list import V1alpha1VolumeAttributesClassList
from kubernetes.rest import ApiException
from pprint import pprint
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_volume_attributes_class(name, v1alpha1_volume_attributes_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
