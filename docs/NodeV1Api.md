...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.NodeV1Api(api_client)
    v1_runtime_class = kubernetes.V1RuntimeClass() # V1RuntimeClass | 
    ...
    try:
        api_response = api_instance.create_runtime_class(v1_runtime_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_runtime_class(name, v1_runtime_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
