...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.SchedulingV1Api(api_client)
    v1_priority_class = kubernetes.V1PriorityClass() # V1PriorityClass | 
    ...
    try:
        api_response = api_instance.create_priority_class(v1_priority_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_priority_class(name, v1_priority_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
