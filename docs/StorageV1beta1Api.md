...
```python
import kubernetes
from kubernetes.models.v1beta1_volume_attributes_class import V1beta1VolumeAttributesClass
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.StorageV1beta1Api(api_client)
    v1beta1_volume_attributes_class = kubernetes.V1beta1VolumeAttributesClass() # V1beta1VolumeAttributesClass | 
    ...
    try:
        api_response = api_instance.create_volume_attributes_class(v1beta1_volume_attributes_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_volume_attributes_class(name, v1beta1_volume_attributes_class, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
