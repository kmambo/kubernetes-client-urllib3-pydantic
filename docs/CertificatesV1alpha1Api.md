...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.CertificatesV1alpha1Api(api_client)
    v1alpha1_cluster_trust_bundle = kubernetes.V1alpha1ClusterTrustBundle() # V1alpha1ClusterTrustBundle | 
    ...
    try:
        api_response = api_instance.create_cluster_trust_bundle(v1alpha1_cluster_trust_bundle, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
```python
import kubernetes
from kubernetes.models.v1alpha1_cluster_trust_bundle_list import V1alpha1ClusterTrustBundleList
from kubernetes.rest import ApiException
from pprint import pprint
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_cluster_trust_bundle(name, v1alpha1_cluster_trust_bundle, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
