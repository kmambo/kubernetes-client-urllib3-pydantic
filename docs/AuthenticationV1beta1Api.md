...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.AuthenticationV1beta1Api(api_client)
    v1beta1_self_subject_review = kubernetes.V1beta1SelfSubjectReview() # V1beta1SelfSubjectReview | 
    ...
    try:
        api_response = api_instance.create_self_subject_review(v1beta1_self_subject_review, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, pretty=pretty)
