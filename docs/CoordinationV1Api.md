...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.CoordinationV1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1_lease = kubernetes.V1Lease() # V1Lease | 
    ...
    try:
        api_response = api_instance.create_namespaced_lease(namespace, v1_lease, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_namespaced_lease(name, namespace, v1_lease, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
