...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.DiscoveryV1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1_endpoint_slice = kubernetes.V1EndpointSlice() # V1EndpointSlice | 
    ...
    try:
        api_response = api_instance.create_namespaced_endpoint_slice(namespace, v1_endpoint_slice, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_namespaced_endpoint_slice(name, namespace, v1_endpoint_slice, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
