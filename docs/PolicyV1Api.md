...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.PolicyV1Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1_pod_disruption_budget = kubernetes.V1PodDisruptionBudget() # V1PodDisruptionBudget | 
    ...
    try:
        api_response = api_instance.create_namespaced_pod_disruption_budget(namespace, v1_pod_disruption_budget, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_namespaced_pod_disruption_budget(name, namespace, v1_pod_disruption_budget, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_namespaced_pod_disruption_budget_status(name, namespace, v1_pod_disruption_budget, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
