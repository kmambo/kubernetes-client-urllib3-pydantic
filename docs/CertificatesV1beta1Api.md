...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.CertificatesV1beta1Api(api_client)
    v1beta1_cluster_trust_bundle = kubernetes.V1beta1ClusterTrustBundle() # V1beta1ClusterTrustBundle | 
    ...
    try:
        api_response = api_instance.create_cluster_trust_bundle(v1beta1_cluster_trust_bundle, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
```python
import kubernetes
from kubernetes.models.v1beta1_cluster_trust_bundle_list import V1beta1ClusterTrustBundleList
from kubernetes.rest import ApiException
from pprint import pprint
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_cluster_trust_bundle(name, v1beta1_cluster_trust_bundle, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
