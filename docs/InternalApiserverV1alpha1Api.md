...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.InternalApiserverV1alpha1Api(api_client)
    v1alpha1_storage_version = kubernetes.V1alpha1StorageVersion() # V1alpha1StorageVersion | 
    ...
    try:
        api_response = api_instance.create_storage_version(v1alpha1_storage_version, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_storage_version(name, v1alpha1_storage_version, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_storage_version_status(name, v1alpha1_storage_version, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
