...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.ApiextensionsV1Api(api_client)
    v1_custom_resource_definition = kubernetes.V1CustomResourceDefinition() # V1CustomResourceDefinition | 
    ...
    try:
        api_response = api_instance.create_custom_resource_definition(v1_custom_resource_definition, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_custom_resource_definition(name, v1_custom_resource_definition, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_custom_resource_definition_status(name, v1_custom_resource_definition, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
