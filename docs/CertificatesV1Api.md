...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.CertificatesV1Api(api_client)
    v1_certificate_signing_request = kubernetes.V1CertificateSigningRequest() # V1CertificateSigningRequest | 
    ...
    try:
        api_response = api_instance.create_certificate_signing_request(v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_certificate_signing_request(name, v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_certificate_signing_request_approval(name, v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_certificate_signing_request_status(name, v1_certificate_signing_request, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
