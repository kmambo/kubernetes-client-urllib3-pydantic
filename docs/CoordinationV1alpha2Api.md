...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes.CoordinationV1alpha2Api(api_client)
    namespace = 'namespace_example' # str | object name and auth scope, such as for teams and projects
    v1alpha2_lease_candidate = kubernetes.V1alpha2LeaseCandidate() # V1alpha2LeaseCandidate | 
    ...
    try:
        api_response = api_instance.create_namespaced_lease_candidate(namespace, v1alpha2_lease_candidate, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
with kubernetes.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.replace_namespaced_lease_candidate(name, namespace, v1alpha2_lease_candidate, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
